...
objetivos da dissertação apresentados na Seção \ref{sec:obj_especificos}. Na tabela são apresentados os problemas presentes nos \textit{frameworks}
...
Dado o desenvolvimento do \textit{Frameworka} PON C++ 4.0, a Tabela
