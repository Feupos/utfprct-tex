...
\begin{figure}[!htb]
  ...
  \caption*{Fonte: \citeonline{neves_icist_2021}}
  \label{fig:nop_rule}
\end{figure}
...
%\includegraphics[width=0.6\textwidth]{../figures/fbe.png} \caption{Estrutura do
%\textit{FBE} no PON} \caption*{Fonte: \citeonline{msc_Banaszewski_2009}}
